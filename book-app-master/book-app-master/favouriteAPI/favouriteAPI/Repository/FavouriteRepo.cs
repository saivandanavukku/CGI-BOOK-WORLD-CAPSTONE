...
namespace favouriteAPI.Repository
{
    public class FavouriteRepo : IFavouriteRepo
    {
        ...
        public bool DeleteFavourite(string userId,string Title)
        {
            DeleteResult deleteResult = db.Fav.DeleteOne(c => c.UserId ==userId && c.Title==Title);
        ...
        public object DeleteFavourite(string id)
        {
